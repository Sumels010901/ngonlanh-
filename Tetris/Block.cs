...
namespace Tetris
{
    ...
    class Block
    {
        ...
        private Int32[] getColorSet()
        {
            ...
            Int32 cyan = Convert.ToInt32("0xFF00FFFF", 16);
            Int32 green = Convert.ToInt32("0xFF66FF00", 16);
            Int32 red = Convert.ToInt32("0xFFFF0000", 16);
            Int32 orange = Convert.ToInt32("0xFFFFA500", 16);
            Int32 pink = Convert.ToInt32("0xffff00ff", 16);
            
            Int32[] set = { blue, yellow, green, cyan, red, orange, pink };
            return set;
        }
    }
}
